class UserCardsController < ApplicationController
  def destroy
    ...
    if @in_hand_players_card_count == @in_hand_players.count * 2 && @hand.name == "Pineapple"
    ...
    elsif @in_hand_players_card_count == @in_hand_players.count * 2 && @hand.name == "Sutra" && @hand.turn_cards.count == 0
      @used_cards = []
      @hand.user_cards.each do |user_card|
        @used_cards << user_card.deck_card
      end
    ...
    elsif @in_hand_players_card_count == @in_hand_players.count * 2 && @hand.name == "Sutra" && @hand.turn_cards.count == 1
      @used_cards = []
      @hand.user_cards.each do |user_card|
        @used_cards << user_card.deck_card
      end
      ...
      @available_cards = DeckCard.all - @used_cards - @flop_cards - @turn_card
